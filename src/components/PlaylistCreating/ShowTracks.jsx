...
export default function ShowTracks({ name, id, setAddedTracks }) {
    ...
    return (
        <div
            className="bg-gradient-to-r from-purple-600 to-pink-500 p-6 rounded-4xl shadow-2xs transform hover:scale-105 transition-all duration-300 hover:shadow-lg max-w-full max-h-[70px] ">
            <h2
